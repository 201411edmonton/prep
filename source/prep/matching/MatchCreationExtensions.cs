...
namespace prep.matching
{
  public static class MatchCreationExtensions
  {
    public static IMatchA<ItemToMatch> equal_to<ItemToMatch, AttributeType>(
      this ICreateAMatcher<ItemToMatch, AttributeType> extension_point, params AttributeType[] values)
    {
    ...
    public static IMatchA<ItemToMatch> greater_than<ItemToMatch, AttributeType>(
      this ICreateAMatcher<ItemToMatch, AttributeType> extension_point, AttributeType value)
    ...
    public static IMatchA<ItemToMatch> between<ItemToMatch, AttributeType>(
      this ICreateAMatcher<ItemToMatch, AttributeType> extension_point, AttributeType start,
    ...
    public static IMatchA<ItemToMatch> create_from_condition<ItemToMatch, AttributeType>(
      this ICreateAMatcher<ItemToMatch, AttributeType> extension_point, Condition<ItemToMatch> condition)
    {
    ...
    public static IMatchA<ItemToMatch> create_from_value_matcher<ItemToMatch, AttributeType>(
      this ICreateAMatcher<ItemToMatch, AttributeType> extension_point, IMatchA<AttributeType> value_matcher)
    {
